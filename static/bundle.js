...
projects = 
{
	text: [
	{
		...
		description: "Канал в Телеграме, где я думаю текстом уже три с половиной года. Изначально был про ненависть и рейдж, а потом оказалось, что я, наоборот, всё обожаю. Пишу редко.", 
		external: true
	},
